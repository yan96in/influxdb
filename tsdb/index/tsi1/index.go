...
// DropSeries drops the provided series from the index.  If cacscade is true
// and this is the last series to the measurement, the measurment will also be dropped.
func (i *Index) DropSeries(seriesID uint64, key []byte, cacscade bool) error {
...
// DropMeasurementIfSeriesNotExist drops a measurement only if there are not more
